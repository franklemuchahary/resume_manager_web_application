    ...
    <div class="row">
      <div class="col-md-6">
        <div class="box">
          ...
          <!-- form start -->
          <form role="form" action="<?php echo base_url('intern/intern_student/change_password/');?>" method="post">
            <div class="box-body">
      ...
      <div class="col-md-6">
        <div class="box">
          ...
          <!-- form start -->
          <form role="form" action="<?php echo base_url('intern/intern_student/change_security_question/');?>" method="post">
            <div class="box-body">
              <div class="form-standard text-center">
