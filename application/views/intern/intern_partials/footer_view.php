 ...
 ?>
      ...
      <!-- all ajax script-->
      <?php if($this->uri->segment(3)=="job_openings"): ?>
      <script src="<?php echo base_url();?>js/ajax_search/intern_ajax/intern_student_ajaxsearch.js"></script>
      <?php endif; ?>
      <!-- all ajax scripts end-->
      ...
      <?php endif; ?>
      <!-- magnific popup script ends -->


      <!-- Countdown timer script starts-->
      <?php if($this->uri->segment(3)=="recruiter_profile"): ?>
      ...
      <?php endforeach; endif; endif;//last one for the uri segment block ?>
