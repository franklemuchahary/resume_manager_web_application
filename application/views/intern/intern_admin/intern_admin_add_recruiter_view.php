...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
     Intern Add Recruiter/Internship            
   </h1>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <!-- form start -->
        <form role="form" action="<?php echo base_url()?>admin/admin_intern/make_new_recruiter" method="post">
          <div class="box-body">
     ...
     <div class="box">
      ...
      <!-- form start -->
      <form role="form" action="<?php echo base_url();?>admin/admin_intern/create_new_student_account" method="post">
        <div class="box-body">
