				...
				<ul class="timeline">
					...
					<li>
						...
						<div class="timeline-item">
							...
							<span class="delete"><a href="<?php echo base_url();?>admin/admin_intern/delete_notifications/<?php echo $row['id'].'/'.$row['recruiter_username']?>" title="DELETE"><i class="fa fa-trash"></i></a></span>
