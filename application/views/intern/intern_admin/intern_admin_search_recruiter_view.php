  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Search Recruiters/Internship Openings
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools">
                ...
                <div class="input-group yo" >
                  <input type="text" name="table_search" data-toggle="tooltip" data-placement="left" title="Eg:btech,facebook,computer.." class="form-control input-sm pull-right" placeholder="Search" onkeyup="admin_recruiter_search(this.value)">
            ...
            <div class="box-body table-responsive no-padding" >
              ...
              <tr onclick="void window.open('<?php echo base_url();?>admin/admin_intern/recruiter_profile_applications/<?php echo $row['recruiter_username'];?>')" >                    
