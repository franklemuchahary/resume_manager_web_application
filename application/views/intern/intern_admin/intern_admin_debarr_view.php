  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
       ...
       <div class="box">
        <!-- form start -->
        <form role="form" action="<?php echo base_url()?>admin/admin_intern/debarr_roll_number" method="post">
      ...
      <div class="box"> <!--box-->
        ...
        <form role="form" action="<?php echo base_url()?>admin/admin_intern/undebarr_student" method="post">
