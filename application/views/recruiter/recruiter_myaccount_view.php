    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          ...
          <!-- form start -->
          <form role="form" action="<?php echo base_url();?>recruiter/recruiter_change_password/" method="post">
            <div class="box-body">
          ...
          <!-- form start -->
          <form role="form" action="<?php echo base_url();?>recruiter/recruiter_change_security_question/" method="post">
            <div class="box-body">
              <div class="form-standard text-center">
