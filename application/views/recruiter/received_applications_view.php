 ...
 <div class="content-wrapper">
 	...
 	<section class="buttons"> 
 		...
 		if(!empty($applications_received)){
 			echo '<div class="export_button "><a href="'.base_url().'excel_exports/excel_received_applications">Export</a></div>';
 			echo '<!--<input type="submit" class="export_button" value="Update"> -->';
 		}
 		?>         
 	</section>
 	<!-- Main content -->
 	<section class="content">
 		<div class="row">
 			<div class="col-xs-12">
 				<div class="box">
 					...
 					<div class="box-body table-responsive no-padding">
 						<table class="table table-hover">
 							...
 							<form action="<?php echo base_url();?>recruiter/application_status" method="post">
 							<?php 
 				...
 				<input type="submit" class="update_button" style="margin-top: 0px;
								    margin-left: auto;
								    margin-right: auto;
								    display: flex;
								    justify-content: center;" value="Update">
 					</form>
