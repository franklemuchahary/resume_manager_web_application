  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        {academic_info}
        <!-- form start -->
        <form role="form" action="<?php echo base_url();?>student/change_academic_info/" method="post">
          <div class="box-body">
            ...
            <div class="form-group col-md-12" >
              ...
              <textarea type="text" rows="3" class="form-control" name="work_experience" placeholder="Enter Work Experience">{work_experience}</textarea>
            </div>
            ...
            <div class="form-group col-md-12">
              <label>Backlog Subjects(Subject1,Subject2...)</label>
              <input type="text" class="form-control" name="backlog_subjects"  placeholder="Name of Subjects with Backlogs" value="{backlog_subjects}">            
            </div>

            <div class="form-group col-md-12">
              <label>Backlog Declaration</label>
            ...
            <div class="form-group col-md-12">
              <input type="checkbox" name="tnc_declaration" value="yes_accepted" required/>&nbsp<strong>I hereby acknowledge that the information provided be me is correct to the best of my knowledge and I am solely responsible for any discrepency!</strong>
            </div>
