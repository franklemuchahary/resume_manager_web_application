  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Search Recruiters/Job Openings
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding" >
              ...
              <tr onclick="void window.open('<?php echo base_url();?>admin/admin_main/recruiter_profile_applications/<?php echo $row['recruiter_username'];?>')" >                    
