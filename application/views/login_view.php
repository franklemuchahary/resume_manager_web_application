...
<head>
       ...
       <div class="row">
         ...
         <div class="form col-md-6 col-sm-8 col-sm-push-2 col-md-push-3 col-xs-11 ">
          ...
          <ul class="tab-group">
            ...
            <li class="tab"><a href="#recruiters">Recruiter</a></li>
          </ul>
          ...
          <div class="tab-content">
            ...
            <div id="student">   
              ...
              <form action="<?php echo base_url();?>login/student_login_handle" method="post">

                <div class="field-wrap">
                  <label>
                    <i class="fa fa-user"></i>Student Username<span class="req">*</span>
                  </label>
                  <input type="text" id="student_username_rollnumber" name="student_username_rollnumber" required autocomplete="off"/>
                </div>

                <div class="field-wrap">
                  <label>
                    <i class="fa fa-lock"></i>Password<span class="req">*</span>
                  </label>
            ...
            <div id="recruiters">   
              <?php echo validation_errors(); ?>
              <form action="<?php echo base_url();?>login/recruiter_login_handle" method="post">

                <div class="field-wrap">
                  <label>
                   <i class="fa fa-user-secret"></i>Recruiter Username<span class="req">*</span>
                 </label>
                 <input type="text" required autocomplete="off" name="recruiter_username" />
               </div>
               ...
               <div class="field-wrap">
                ...
                <input type="password" required autocomplete="off" name="recruiter_password" />
              </div>
  ...
  <h2 style="text-align: center; color: white;"><a href="<?php echo base_url('intern/intern_login')?>">Intern Resume Manager</a></h2>
