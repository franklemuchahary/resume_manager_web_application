...
function admin_recruiter_search(str) {
    ...
    xmlhttp.open("GET","http://localhost/git-repos/rm_dtu/admin/admin_intern/search_recruiter/"+str,true);
    xmlhttp.send();
}
...
function admin_student_search(str) {
    ...
    xmlhttp.open("GET","http://localhost/git-repos/rm_dtu/admin/admin_intern/search_students/"+encodeURIComponent(str),true);
    xmlhttp.send();
}
...
function admin_all_applications_search(str) {
    ...
    xmlhttp.open("GET","http://localhost/git-repos/rm_dtu/admin/admin_intern/all_applications_search/"+encodeURIComponent(str),true);
    xmlhttp.send();
}